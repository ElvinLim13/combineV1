...
namespace Assignment_Manager_v1
{
    public class RefreshCompetition
    {
        public void RefreshDataGridS_SearchStudent(DataGridView dataGridView)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\Elvin Lim\\OneDrive\\文档\\IOOC\\Assigment19-3\\Assigment19-3\\Database1.mdf\";Integrated Security=True"))
            {
                // 在这里执行数据库操作
                con.Open();
                string query_RefreshDataGrid = "Select userID, userName From UserInfo where exists (Select MemberID from CompetitionMember where CompetitionMember.MemberID = UserInfo.userID)";
        ...
        public void SearchCompetitionStudent(DataGridView dataGridView, TextBox TxtSearch)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\Elvin Lim\\OneDrive\\文档\\IOOC\\Assigment19-3\\Assigment19-3\\Database1.mdf\";Integrated Security=True"))
            {
                ...
                string query_RefreshDataGrid = @"
                    ...
                    FROM UserInfo ui
                    JOIN CompetitionMember cm ON cm.MemberID = ui.userID
        ...
        public class RecommendStudent
        {
            ...
            public void AssignStudent(Label LblStudentID, Label LblCompetitionID)
            {
                ...
                {
                    con.Open();
                    string query = "Insert into CompetitionMember values(@competitionID, @userID, 'Null');";
                ...
                {
                    con.Open();
                    string query = "DELETE FROM RecommendedMember WHERE MemberID = @userID and CompetitionID = @competitionID;";
